...
* The p-value in the chi-squared test is `r chitest2$p.value` that is much smaller than the significance level (0.05). Therefore, we reject the null.
