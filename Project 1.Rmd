...
In this part, we will identify which genre is the most profitable.
...
* From the first figure (with outliers), both the most net-income movie and the most net-loss movie belong to Action genre. Although, Action movies grant high income, it is too risky to spend on this genre. 
...
* Movie companies and directors are recommended to invest these two categories: Animation and Horror.
...
* High-profit movies (the majority are action movies) require pretty high budgets (more than `r quantile(movies_fam$budget, 0.95, na.rm=T)*(1e-6)` m$, i.e 95 percentile value).
* Horror movies have a low budget but their income is impressive. This genre seems to be the most successful. We will confirm this with analysis on Return on Investment (ROI).
